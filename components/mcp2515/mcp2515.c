...
ERROR_t MCP2515_reset(void)
{
    ...
    if (MCP2515_Object == NULL || MCP2515_Object->spi == NULL)
    {
        ESP_LOGE(TAG_MCP2515, "MCP2515 Object or SPI is NULL");
        return ERROR_FAIL;
    }
    else
    {
        ESP_LOGI(TAG_MCP2515, "MCP2515 Object and SPI are not NULL");
    }
